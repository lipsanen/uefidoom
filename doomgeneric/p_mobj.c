...
boolean
P_SetMobjState(doom_data_t *doom,
               mobj_t *mobj,
               statenum_t state)
{
    state_t *st;
...
// P_NightmareRespawn
//
void P_NightmareRespawn(doom_data_t *doom, mobj_t *mobj)
{
    fixed_t x;
    fixed_t y;
    fixed_t z;
...
void P_SpawnMapThing(doom_data_t *doom, mapthing_t *mthing)
{
    ...
    if (doom->nomonsters && (i == MT_SKULL || (mobjinfo[i].flags & MF_COUNTKILL)))
    {
        return;
    }
...
void P_SpawnPuff(doom_data_t *doom,
                 fixed_t x,
                 fixed_t y,
                 fixed_t z)
{
...
// P_SpawnBlood
//
void P_SpawnBlood(doom_data_t *doom,
                  fixed_t x,
                  fixed_t y,
                  fixed_t z,
                  int damage)
...
//
mobj_t *
P_SpawnMissile(doom_data_t *doom,
               mobj_t *source,
               mobj_t *dest,
               mobjtype_t type)
{
...
//
void P_SpawnPlayerMissile(doom_data_t *doom,
                          mobj_t *source,
                          mobjtype_t type)
{
    mobj_t *th;
