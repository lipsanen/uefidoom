...
mobj_t *
P_SpawnMobj(struct doom_data_t_ *doom, fixed_t x,
            fixed_t y,
            fixed_t z,
            mobjtype_t type);
...
boolean
P_PathTraverse(doom_data_t *doom,
               fixed_t x1,
               fixed_t y1,
               fixed_t x2,
               fixed_t y2,
...
void P_TouchSpecialThing(struct doom_data_t_ *doom,
                         mobj_t *special,
                         mobj_t *toucher);

void P_DamageMobj(doom_data_t *doom,
                  mobj_t *target,
                  mobj_t *inflictor,
                  mobj_t *source,
                  int damage);
