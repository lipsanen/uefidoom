...
void P_PlayerThink(doom_data_t *doom, player_t *player)
{
	...
	if (cmd->buttons & BT_CHANGE)
	{
		...
		if ((doom->gamemode == commercial) && newweapon == wp_shotgun && player->weaponowned[wp_supershotgun] && player->readyweapon != wp_supershotgun)
		{
		...
		if (player->weaponowned[newweapon] && newweapon != player->readyweapon)
		{
			...
			//  even if cheated.
			if ((newweapon != wp_plasma && newweapon != wp_bfg) || (doom->gamemode != shareware))
			{
