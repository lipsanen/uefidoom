                   ...
                   char key)
{
    ...
    if (cht->parameter_chars > 0 && d_strlen(cht->sequence) < cht->sequence_len)
        return false;

    if (cht->chars_read < d_strlen(cht->sequence))
    {
    ...
    if (cht->chars_read >= d_strlen(cht->sequence) && cht->param_chars_read >= cht->parameter_chars)
    {
