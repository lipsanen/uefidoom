...
//
boolean
P_BlockLinesIterator(doom_data_t *doom,
                     int x,
                     int y,
...
//
boolean
P_BlockThingsIterator(doom_data_t *doom,
                      int x,
                      int y,
...
//
boolean
P_TraverseIntercepts(doom_data_t *doom,
                     traverser_t func,
                     fixed_t maxfrac)
{
    int count;
...
static void InterceptsOverrun(int num_intercepts, intercept_t *intercept)
{
    ...
    InterceptsMemoryOverrun(location + 8, (size_t)intercept->d.thing);
}
